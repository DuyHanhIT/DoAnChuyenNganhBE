...
namespace WebApiShoesStoreDACN.AprioriTest.src
{
    public class AssociationRule
    {
        ...
        public string ToDetailedString1(DataFields dataFields)
        {
            return NodeA.ToDetailedString1(dataFields) + "," + NodeB.ToDetailedString1(dataFields) ;
        }
