...
namespace Cotur.DataMining.Association
{
    public class Apriori_Test
    {
        ...
        {
            var transaction1 = new List<int>() { 3, 6 };
            var transaction2 = new List<int>() { 1004, 6 };
            var transaction3 = new List<int>() { 1005, 1004 };
            var transaction4 = new List<int>() { 1005, 3 };
            var transaction5 = new List<int>() { 1005, 3, 6 };
            var transaction6 = new List<int>() { 1005, 3, 1004 };
            var transaction7 = new List<int>() { 1005, 3, 1004, 6 };
            var transaction8 = new List<int>() { 6, 1005, 1004 };
            var transaction9 = new List<int>() { 3, 6 };
            ...
            myApriori.Rules.Count(x => x.Confidence >= .5f);
